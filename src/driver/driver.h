...
NTSTATUS NTAPI NtWaitForSingleObject(HANDLE,ULONG,PLARGE_INTEGER);
NTSTATUS NTAPI ZwWaitForSingleObject(HANDLE,ULONG,PLARGE_INTEGER);
...
NTSTATUS NTAPI ZwQueryDirectoryFile(HANDLE,HANDLE,PIO_APC_ROUTINE,
		PVOID,PIO_STATUS_BLOCK,PVOID,ULONG,FILE_INFORMATION_CLASS,ULONG,
...
NTSTATUS NTAPI NtNotifyChangeDirectoryFile(HANDLE,HANDLE,PIO_APC_ROUTINE,
		PVOID,PIO_STATUS_BLOCK,PVOID,ULONG,ULONG,ULONG);
