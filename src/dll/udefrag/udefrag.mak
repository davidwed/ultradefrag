...
!IF "$(CFG)" == "udefrag - Win32 Release"
CPP_PROJ=/nologo /Gd /MT /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_USRDLL" /D "UDEFRAG_EXPORTS" /Fp"$(INTDIR)\udefrag.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
!ELSE
CPP_PROJ=/nologo /Gd /MTd /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_USRDLL" /D "UDEFRAG_EXPORTS" /Fp"$(INTDIR)\udefrag.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ  /c 
