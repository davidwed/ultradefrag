...
void ScanMftDirectly(PNTFS_FILE_RECORD_OUTPUT_BUFFER pnfrob,
					  ULONG nfrob_size,PMY_FILE_INFORMATION pmfi);
void ScanMftDirectlyRTL(PNTFS_FILE_RECORD_OUTPUT_BUFFER pnfrob,
					  ULONG nfrob_size,PMY_FILE_INFORMATION pmfi);
void ScanMftDirectlyLTR(PNTFS_FILE_RECORD_OUTPUT_BUFFER pnfrob,
					  ULONG nfrob_size,PMY_FILE_INFORMATION pmfi);

void AnalyseMftRecord(PNTFS_FILE_RECORD_OUTPUT_BUFFER pnfrob,
					  ULONG nfrob_size,PMY_FILE_INFORMATION pmfi);

typedef void (__stdcall *ATTRHANDLER_PROC)(PATTRIBUTE pattr,PMY_FILE_INFORMATION pmfi);
...
void __stdcall GetFileNameAndParentMftIdFromMftRecordCallback(PATTRIBUTE pattr,PMY_FILE_INFORMATION pmfi);
...
void AnalyseSingleAttribute(ULONGLONG mft_id,PFILE_RECORD_HEADER pfrh,ATTRIBUTE_TYPE attr_type,short *attr_name,USHORT attr_number,PMY_FILE_INFORMATION pmfi);
...
void BuildPath(PMY_FILE_INFORMATION pmfi);
...
void ProcessMFTRunList(PNONRESIDENT_ATTRIBUTE pnr_attr);
void ProcessMFTRun(ULONGLONG vcn,ULONGLONG length,ULONGLONG lcn);
