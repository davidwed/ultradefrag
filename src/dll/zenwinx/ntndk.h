...
NTSTATUS	NTAPI	NtWaitForSingleObject(HANDLE,ULONG,const LARGE_INTEGER*);
NTSTATUS	NTAPI	NtDisplayString(PUNICODE_STRING); 
NTSTATUS	NTAPI	NtInitializeRegistry(ULONG);
...
NTSTATUS	NTAPI	NtAdjustPrivilegesToken(HANDLE,ULONG,PTOKEN_PRIVILEGES,DWORD,PTOKEN_PRIVILEGES,PDWORD);
NTSTATUS	NTAPI	NtDelayExecution(ULONG,const LARGE_INTEGER*);
...
NTSTATUS	NTAPI	NtClose(HANDLE);
NTSTATUS	NTAPI	RtlCreateUserThread(HANDLE,PSECURITY_DESCRIPTOR,ULONG,LONG,ULONG,ULONG,PTHREAD_START_ROUTINE,PVOID,PHANDLE,PCLIENT_ID);
...
NTSTATUS	NTAPI	RtlAnsiStringToUnicodeString(PUNICODE_STRING,PANSI_STRING,ULONG);
NTSTATUS	NTAPI	RtlUnicodeStringToAnsiString(PANSI_STRING,PUNICODE_STRING,ULONG);
...
NTSTATUS	NTAPI	NtQueryDirectoryFile(HANDLE,HANDLE,PIO_APC_ROUTINE,PVOID,PIO_STATUS_BLOCK,PVOID,ULONG,FILE_INFORMATION_CLASS,ULONG,PUNICODE_STRING,ULONG);
